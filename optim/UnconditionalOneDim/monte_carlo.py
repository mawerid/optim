"""Monte Carlo method for unconstrained optimization.
"""
...
def find_min(func: Callable[[float], float], interval: np.ndarray, point_num: int,
    ...
    Parameters:
        ...
        point_num (int): The number of points to generate within the interval.
...
def find_max(func: Callable[[float], float], interval: np.ndarray, point_num: int,
             verbose: bool = False, return_argmin: bool = False) -> float:
